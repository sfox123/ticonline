      ...
      <div className="container-fluid p-0">
        <div className="row gx-0 align-items-center">
          ...
          >
            <div className="td-team-4-item p-relative">
              <div className="td-team-4-thumb p-relative">
                <img className="w-100" src={bg2Img} alt="thumb" />
                <span></span>
              </div>
              <div className="td-team-4-content">
                <span>Founder</span>
          ...
          >
            <div className="td-team-4-title-wrap ml-120">
              <span className="td-section-title-pre mb-10">ON GOING</span>
              <h2 className="td-section-title mb-90">
          ...
          >
            <div className="td-team-4-item p-relative">
              <div className="td-team-4-thumb p-relative">
                <img className="w-100" src={bg3Img} alt="thumb" />
                <span></span>
              </div>
              <div className="td-team-4-content">
                <span>Founder</span>
          ...
          >
            <div className="td-team-4-item p-relative">
              <div className="td-team-4-thumb p-relative">
                <img className="w-100" src={bg4Img} alt="thumb" />
                <span></span>
              </div>
              <div className="td-team-4-content">
                <span>Founder</span>
          ...
          >
            <div className="td-team-4-item p-relative">
              <div className="td-team-4-thumb p-relative">
                <img className="w-100" src={bg5Img} alt="thumb" />
                <span></span>
              </div>
              <div className="td-team-4-content">
                <span>Founder</span>
          ...
          >
            <div className="td-team-4-item p-relative">
              <div className="td-team-4-thumb p-relative">
                <img className="w-100" src={bg6Img} alt="thumb" />
                <span></span>
              </div>
              <div className="td-team-4-content">
                <span>Founder</span>
